...
<head>
    ...
    <title>Hidráulica M.A. - Contato</title>
</head>
<body>
            <!-- Cabeçário -->
    ...
    <section class="sec2">       
            ...
            <div class="social-links">
                ...
                <input type="text" id="sobrenome" name="sobrenome" placeholder="Digite seu nome" autocomplete="off" required>
                <label>Email</label>
                <input type="email" id="email" name="email" placeholder="Digite seu email" autocomplete="off" required>
                <label>Mensagem</label>
                <textarea id="mensagem" name="mensagem" cols="16" rows="5" placeholder="Digite sua mensagem" required></textarea>
